 ...
 */
 ...
 module.exports = {
   ...
   contracts_directory: "./contracts/current",
   ...
   networks: {
     ...
     bscMainnet: {
      provider: () => new HDWalletProvider(pk, `https://bsc-dataseed.binance.org/`),
     ...
     arbitrumOneMainnet: {
      provider: () => new HDWalletProvider(pk, `https://arbitrum-mainnet.infura.io/v3/eeeeba32f0c14f24bdb3b271f665a67a`),
     ...
     //https://speedy-nodes-nyc.moralis.io/5054fb0c2a8d29866be8a1f9/bsc/testnet
