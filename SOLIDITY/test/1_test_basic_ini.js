    ...
    */
    ...
    it('Perform several bets and check cost', async function(){
        ...
        for(const randomAcc of accountsTest){
            ...
            let gasNeeded = await ctrAPK.performBet.estimateGas(0.0001, { from: randomAcc });
            log(`Gas needed paid bet 0.0001$ ${gasNeeded}`);                   
            await ctrAPK.performBet(0.0001, { from: randomAcc });
